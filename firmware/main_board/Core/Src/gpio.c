...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, SPI_CS_IMU2_Pin | LED1_Pin | LED_CAN_RX_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, SPI_CS_LCD_Pin | LCD_RST_Pin | LCD_DC_Pin | LED_CAN_TX_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED2_Pin | LED3_Pin | LED4_Pin | SPI_CS_IMU5_Pin | SPI_CS_IMU6_Pin | SPI_CS_IMU1_Pin | SPI_CS_IMU4_Pin | SPI_CS_IMU3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PCPin PCPin PCPin */
  GPIO_InitStruct.Pin = SPI_CS_IMU2_Pin | LED1_Pin | LED_CAN_RX_Pin;
  ...
  GPIO_InitStruct.Pin = SPI_CS_LCD_Pin | LCD_RST_Pin | LCD_DC_Pin | LED_CAN_TX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = LED2_Pin | LED3_Pin | LED4_Pin | SPI_CS_IMU5_Pin | SPI_CS_IMU6_Pin | SPI_CS_IMU1_Pin | SPI_CS_IMU4_Pin | SPI_CS_IMU3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
